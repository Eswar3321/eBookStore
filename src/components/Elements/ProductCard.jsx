...
export const ProductCard = ({ product }) => {
  ...
  const { id, name, price, rating, poster, overview, best_seller } = product;
  let inCart = cartList.find((item) => item.id === product.id);
  return (
    <div className="m-3 max-w-sm text-left bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
